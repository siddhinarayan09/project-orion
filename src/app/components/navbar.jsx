  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg: px-8 xl: px-[8%] py-4 flex items-centre justify-between z-50 ${isScroll ? "bg-white/30 backdrop-blur-lg shadow-sm" : ""}`}>
        <a href='#top'>
            ...
            <ul className={`hidden md:flex items-centre gap-6 lg: gap-8 rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50"}
            `}>
                <li><a className='font-Ovo' href='#top'> Home </a></li>
                <li><a className='font-Ovo' href='#about'> About me </a></li>
                <li><a className='font-Ovo' href='#services'> Serivces </a></li>
            ...
            <div className = 'flex items-center gap-4 cursor-pointer'> 
                ...
                <a href='#contact' className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'> Contact <Image src = {assets.arrow_icon} className='w-3'/></a>
